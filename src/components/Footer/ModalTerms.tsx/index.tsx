...
const ModalTerms = (props: ModalTermsProps) => {
  ...
  return (
    ...
    >
      <p>표준약관 제10023호 (2015. 6. 26. 개정)</p>

      <TermItem idx={1} title="목적">
        <p>
          이 약관은 헬륨가스 회사(전자상거래 사업자)가 운영하는 (이하
      ...
      <TermItem idx={2} title="정의">
        <CircleList>
          <CircleItem>
            &ldquo;몰&rdquo;이란 OO 회사가 재화 또는 용역(이하 &ldquo;재화
            등&rdquo;이라 함)을 이용자에게 제공하기 위하여 컴퓨터 등
          ...
          <CircleItem>
            &lsquo;회원&rsquo;이라 함은 &ldquo;몰&rdquo;에 회원등록을 한 자로서,
            계속적으로 &ldquo;몰&rdquo;이 제공하는 서비스를 이용할 수 있는 자를
            말합니다.
          </CircleItem>
          <CircleItem>
            &lsquo;비회원&rsquo;이라 함은 회원에 가입하지 않고
            &ldquo;몰&rdquo;이 제공하는 서비스를 이용하는 자를 말합니다.
          </CircleItem>
        </CircleList>
      </TermItem>

      <TermItem idx={3} title="약관 등의 명시와 설명 및 개정">
        <CircleList>
          <CircleItem>
          ...
          <CircleItem>
            ...
            공지합니다. 이 경우 &ldquo;몰&rdquo;은 개정 전 내용과 개정 후 내용을
          ...
          <CircleItem>
            ...
            의한 개정약관의 공지기간 내에 &ldquo;몰&rdquo;에 송신하여
      ...
      <TermItem idx={4} title="서비스의 제공 및 변경">
        <CircleList>
          <CircleItem>
          ...
          <CircleItem>
            &ldquo;몰&rdquo;은 재화 또는 용역의 품절 또는 기술적 사양의 변경
            등의 경우에는 장차 체결되는 계약에 의해 제공할 재화 또는 용역의
            내용을 변경할 수 있습니다. 이 경우에는 변경된 재화 또는 용역의 내용
            및 제공일자를 명시하여 현재의 재화 또는 용역의 내용을 게시한 곳에
            즉시 공지합니다.
          </CircleItem>
          <CircleItem>
          ...
          <CircleItem>
            ...
            배상합니다. 다만, &ldquo;몰&rdquo;이 고의 또는 과실이 없음을
            입증하는 경우에는 그러하지 아니합니다.
          </CircleItem>
        </CircleList>
      </TermItem>
      <TermItem idx={5} title="서비스의 중단">
        <CircleList>
          <CircleItem>
      ...
      <TermItem idx={7} title="회원 탈퇴 및 자격 상실 등">
        <CircleList>
          <CircleItem>
          ...
          <CircleItem>
            ...
            <ol>
              ...
              <li>
                “몰”을 이용하여 구입한 재화 등의 대금, 기타 “몰”이용에 관련하여
      ...
      <TermItem idx={8} title="회원에 대한 통지">
        <CircleList>
          <CircleItem>
      ...
      <TermItem idx={9} title="구매신청 및 개인정보 제공 동의 등">
        <CircleList>
          <CircleItem>
          ...
          <CircleItem>
            ...
            위탁하는 경우에는 1) 개인정보 취급위탁을 받는 자, 2) 개인정보
            취급위탁을 하는 업무의 내용을 구매자에게 알리고 동의를 받아야
            합니다. (동의를 받은 사항이 변경되는 경우에도 같습니다.) 다만,
            서비스제공에 관한 계약이행을 위해 필요하고 구매자의 편의증진과
            관련된 경우에는 「정보통신망 이용촉진 및 정보보호 등에 관한
            법률」에서 정하고 있는 방법으로 개인정보 취급방침을 통해 알림으로써
            고지절차와 동의절차를 거치지 않아도 됩니다.
          </CircleItem>
        </CircleList>
      </TermItem>
      <TermItem idx={10} title="계약의 성립">
        <CircleList>
          <CircleItem>
            “몰”은 제9조와 같은 구매신청에 대하여 다음 각 호에 해당하면 승낙하지
      ...
      <TermItem idx={11} title="지급방법">
        “몰”에서 구매한 재화 또는 용역에 대한 대금지급방법은 다음 각 호의 방법중
        가용한 방법으로 할 수 있습니다. 단, “몰”은 이용자의 지급방법에 대하여
      ...
      <TermItem idx={12} title="수신확인통지․구매신청 변경 및 취소">
        <CircleList>
          <CircleItem>
      ...
      <TermItem idx={13} title="재화 등의 공급">
        <CircleList>
          <CircleItem>
          ...
          <CircleItem>
            ...
            경우에는 그로 인한 이용자의 손해를 배상하여야 합니다. 다만 “몰”이
            고의․과실이 없음을 입증한 경우에는 그러하지 아니합니다.
          </CircleItem>
        </CircleList>
      </TermItem>
      <TermItem idx={14} title="환급">
        “몰”은 이용자가 구매신청한 재화 등이 품절 등의 사유로 인도 또는 제공을
        할 수 없을 때에는 지체 없이 그 사유를 이용자에게 통지하고 사전에 재화
        등의 대금을 받은 경우에는 대금을 받은 날부터 3영업일 이내에 환급하거나
        환급에 필요한 조치를 취합니다.
      </TermItem>
      <TermItem idx={15} title="청약철회 등">
        <CircleList>
          <CircleItem>
          ...
          <CircleItem>
            제2항제2호 내지 제4호의 경우에 “몰”이 사전에 청약철회 등이 제한되는
            사실을 소비자가 쉽게 알 수 있는 곳에 명기하거나 시용상품을 제공하는
            등의 조치를 하지 않았다면 이용자의 청약철회 등이 제한되지 않습니다.
          </CircleItem>
          <CircleItem>
            이용자는 제1항 및 제2항의 규정에 불구하고 재화 등의 내용이 표시·광고
            내용과 다르거나 계약내용과 다르게 이행된 때에는 당해 재화 등을
            공급받은 날부터 3월 이내, 그 사실을 안 날 또는 알 수 있었던 날부터
            30일 이내에 청약철회 등을 할 수 있습니다.
          </CircleItem>
        </CircleList>
      </TermItem>
      <TermItem idx={16} title="청약철회 등의 효과">
        <CircleList>
          <CircleItem>
          ...
          <CircleItem>
            ...
            부담합니다. “몰”은 이용자에게 청약철회 등을 이유로 위약금 또는
            손해배상을 청구하지 않습니다. 다만 재화 등의 내용이 표시·광고 내용과
            다르거나 계약내용과 다르게 이행되어 청약철회 등을 하는 경우 재화
      ...
      <TermItem idx={17} title="개인정보보호">
        <CircleList>
          <CircleItem>
            “몰”은 이용자의 개인정보 수집시 서비스제공을 위하여 필요한 범위에서
            최소한의 개인정보를 수집합니다.
          </CircleItem>
          <CircleItem>
      ...
      <TermItem idx={19} title="회원의 ID 및 비밀번호에 대한 의무">
        <CircleList>
          <CircleItem>
          ...
          <CircleItem>
            ...
            인지한 경우에는 바로 “몰”에 통보하고 “몰”의 안내가 있는 경우에는
            그에 따라야 합니다.
          </CircleItem>
        </CircleList>
      </TermItem>
      <TermItem idx={20} title="이용자는 다음 행위를 하여서는 안 됩니다.">
        <ol>
      ...
      <TermItem idx={21} title="연결“몰”과 피연결“몰” 간의 관계">
        <CircleList>
          <CircleItem>
      ...
      <TermItem idx={22} title="저작권의 귀속 및 이용제한">
        <CircleList>
          <CircleItem>
      ...
      <TermItem idx={24} title="재판권 및 준거법">
        <CircleList>
          <CircleItem>
